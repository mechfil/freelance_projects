...
| 4.   | [Анализ столкновения птиц с воздушными судами](https://github.com/mechfil/yandex_masterskaya/tree/main/Bird%20strikes) |  Необходимо изучить влияние погоды на столкновения птиц с воздушными судами. На основе исследования будет построена модель предсказания столкновений с птицами коллегами из DS-направления. | Яндекс Мастерская      | Python, Pandas, Matplotlib, Seaborn      | Завершен ✅     |
